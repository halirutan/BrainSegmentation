...
from brainseg.create_fh_seg2 import isolate_labels, resample_to_target, verify_label_consistency_across_overlays
import pytest
...
def test_resample_to_target():
    # Create source image with ones
    source_data = np.ones((2, 2, 2), dtype=np.int32)
    # Create target image with zeros and larger shape
